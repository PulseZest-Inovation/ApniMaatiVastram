        ...
        <div className="flex flex-wrap justify-between items-start space-y-6 sm:space-y-0">
          ...
          <div className="w-full sm:w-1/3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/return-and-refund" className="hover:text-blue-400">
                  Return and Refund
                </Link>
              </li>
              <li>
          ...
          <div className="w-full sm:w-1/3">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/categories/shoes" className="hover:text-blue-400">
                  Shoes
                </Link>
              </li>
              <li>
                <Link href="/categories/cloth" className="hover:text-blue-400">
                  Cloth
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/categories/accessories" className="hover:text-blue-400">
                  Accessories
                </Link>
              </li>
            </ul>
