...
const OtpModal: React.FC<OtpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 transition-opacity ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
    ...
    >
      <div className="bg-white p-6 rounded-lg w-96">
        ...
        <div className="text-center mt-4">
          ...
          {success && <p className="text-green-500">{success}</p>} {/* Success message display */}
        </div>
